  ...
  return (
    <Card>
      ...
      <div className="email-application position-relative h-auto">
        <div
          className={`app-content-overlay ${showManuAdd === "open" ? "show" : ""
            }`}
        ...
        <CardBody>
                      ...
                      <Col md='6' sm='12' className='d-inline-block'>
                        <FormGroup className="form-label-group">
                          <Field
                            ...
                            name="screen"
                            id="screen"
                            className={`form-control ${errors.screen && touched.screen && "is-invalid"
                              }`}
                          />
                      ...
                      <Col md='6' sm='12' className='d-inline-block'>
                        <FormGroup className="form-label-group">
                          <Field
                            ...
                            name="camera_truoc"
                            id="camera_truoc"
                            className={`form-control ${errors.camera_truoc && touched.camera_truoc && "is-invalid"
                              }`}
                          />
                      ...
                      <Col md='6' sm='12' className='d-inline-block'>
                        <FormGroup className="form-label-group">
                          <Field
                            ...
                            name="camera_sau"
                            id="camera_sau"
                            className={`form-control ${errors.camera_sau && touched.camera_sau && "is-invalid"
                              }`}
                          />
                      ...
                      <Col md='6' sm='12' className='d-inline-block'>
                        <FormGroup className="form-label-group">
                          <Field
                            ...
                            name="cpu"
                            id="cpu"
                            className={`form-control ${errors.cpu && touched.cpu && "is-invalid"
                              }`}
                          />
                      ...
                      <Col md='6' sm='12' className='d-inline-block'>
                        <FormGroup className="form-label-group">
                          <Field
                            ...
                            name="pin"
                            id="pin"
                            className={`form-control ${errors.pin && touched.pin && "is-invalid"
                              }`}
                          />
                          <Label for="required">Màn hình</Label>
                        </FormGroup>
                      ...
                      <Col md='6' sm='12' className='d-inline-block'>
                        <FormGroup className="form-label-group">
                          <Field
                            ...
                            name="ram"
                            id="ram"
                            className={`form-control ${errors.ram && touched.ram && "is-invalid"
                              }`}
                          />
                      ...
                      <Col md='6' sm='12' className='d-inline-block'>
                        <FormGroup className="form-label-group">
                          <Field
                            ...
                            name="rom"
                            id="rom"
                            className={`form-control ${errors.rom && touched.rom && "is-invalid"
                              }`}
                          />
                      ...
                      <Col md='6' sm='12' className='d-inline-block'>
                        <FormGroup className="form-label-group">
                          <Field
                            ...
                            name="microsd"
                            id="microsd"
                            className={`form-control ${errors.microsd && touched.microsd && "is-invalid"
                              }`}
                          />
                      ...
                      <Col md='6' sm='12' className='d-inline-block'>
                        <FormGroup className="form-label-group">
                          <Field
                            ...
                            name="os"
                            id="os"
                            className={`form-control ${errors.os && touched.os && "is-invalid"
                              }`}
                          />
                    ...
                    <Col md='6' sm='12'>
                      <FormGroup className="form-label-group">
                        <Input
                          ...
                          id="article"
                          rows="15"
                          className={`form-control ${errors.article && touched.article && "is-invalid"
                            }`}
                        />
          ...
          <ManuAdd setShowManuAdd={setShowManuAdd} showManuAdd={showManuAdd} />
        </CardBody>
      </div>
    </Card>
  );
