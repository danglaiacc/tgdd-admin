...
const phones = lazy(() => import("./views/apps/product/phone/Phones"));
const phoneAdd = lazy(() => import("./views/apps/product/phone/PhoneAdd"));
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute exact path="/phone" component={phones} />
          <AppRoute path="/phone/add" component={phoneAdd} />
          <AppRoute
